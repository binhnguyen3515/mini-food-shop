...
@Component({
  selector: 'app-sharedProductDisplay_2',
  templateUrl: './sharedProductDisplay_2.component.html',
  styleUrls: ['./sharedProductDisplay_2.component.scss']
})
export class SharedProductDisplay_2Component implements OnInit {

...
@Component({
  selector: 'app-sharedProductDisplay_3',
  templateUrl: './sharedProductDisplay_3.component.html',
  styleUrls: ['./sharedProductDisplay_3.component.scss']
})
export class SharedProductDisplay_3Component implements OnInit {
